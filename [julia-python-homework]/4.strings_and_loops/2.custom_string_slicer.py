"""Develop a program that allows users to input a string
# and then perform various slicing operations based on the user input.
...
if step == "no":
    ...
    print(
        f"The sliced string with a step is: {main[start_index : last_index: step_count]}"
    )
