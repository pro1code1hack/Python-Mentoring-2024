...
def cube_measurements(edge_length: int) -> list[int]:
...
def arithmetic_operations(num1: int, num2: int) -> list[int]:
...
mouse_cost_input = 25
total_cost_output = total_cost_of_computer_sets(monitor_cost_input, system_unit_cost_input, keyboard_cost_input, mouse_cost_input)
