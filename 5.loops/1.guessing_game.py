...
and asks the user to guess it. Use a while loop to allow multiple 
attempts until they guess correctly or choose to exit."""
...
while True:
    ...
    if guess_number == 0:
        print(
            f"Exiting... The correct number was {random_number}. Better luck next time!"
        )
        break
