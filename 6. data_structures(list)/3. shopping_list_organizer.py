# Develop a program that helps users organize their shopping list by adding, viewing, removing and sort items alphabetically.
...
while True:
    ...
    print("Menu:", "1. Add item", "2. View list", "3. Remove item", "4. Exit", sep="\n", end="\n")
    print()
    ...
    if option == "add":
        ...
        if len(output) == 0:
            print("Your shopping List is empty. Nothing to revome yet", "____________", sep="\n")
